<%@ page import="connection.PostConnection" %>
...
%>
<button><a href="addPost.jsp">Write your own post</a></button>
<%}

    List<Post> posts = (List<Post>) PostConnection.getPost();
    if(posts!=null){
        for(Post post : posts){
            int commentsNum = PostConnection.getComments(post.getpId()).size();
%>
<div class="post">
